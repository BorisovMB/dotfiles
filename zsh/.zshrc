...
export PATH=$HOME/bin:/usr/local/bin:$HOME/.config/scripts:$PATH:$HOME/.local/bin:$HOME/.local/idea/idea-IC-202.6948.69/bin
...
plugins=( tmux git colored-man-pages )
